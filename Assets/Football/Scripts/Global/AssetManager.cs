...
public class AssetManager : MonoBehaviour
{
    ...
    public List<Sprite> playerSprite0, playerSprite1, playerBodySprite, shoesSprites;
    ...
    {
        for (int i=0;i<playerSprite0.Count-1;i++)
        {
            if (!PlayerPrefs.HasKey("playerSprite0"+i))
            {
                Debug.Log("nety");
    ...
    void Awake()
    {
        ...
        PlayerPrefs.SetInt("playerSprite0" + 1,1);
        PlayerPrefs.SetInt("playerSprite0" + 2, 1);
        CheckBuying();
