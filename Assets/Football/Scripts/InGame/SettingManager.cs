...
public class SettingManager : MonoBehaviour
{
    ...
    public int PlayerBodyIndex
    {
        set
        {
            ...
            playerBodySelectedObj.GetChild(0).gameObject.SetActive(!(value >= AssetManager.Use.playerBodySprite.Count - 1));
    ...
    public int PlayerShoesIndex
    {
        set
        {
            ...
            playerShoesSelectedObj.GetChild(0).gameObject.SetActive(!(value >= AssetManager.Use.shoesSprites.Count - 1));
